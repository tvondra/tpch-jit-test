...
COPY part FROM '/mnt/data/tpch/10/part.csv' WITH DELIMITER '|' CSV;

COPY region FROM '/mnt/data/tpch/10/region.csv' WITH DELIMITER '|' CSV;

COPY nation FROM '/mnt/data/tpch/10/nation.csv' WITH DELIMITER '|' CSV;

COPY supplier FROM '/mnt/data/tpch/10/supplier.csv' WITH DELIMITER '|' CSV;

COPY customer FROM '/mnt/data/tpch/10/customer.csv' WITH DELIMITER '|' CSV;

COPY partsupp FROM '/mnt/data/tpch/10/partsupp.csv' WITH DELIMITER '|' CSV;

COPY orders FROM '/mnt/data/tpch/10/orders.csv' WITH DELIMITER '|' CSV;

COPY lineitem FROM '/mnt/data/tpch/10/lineitem.csv' WITH DELIMITER '|' CSV;
